...
tags: [web, recon, fuzzing, ffuf, gobuster, whatweb, nikto]
---
...
Use Burp's Target → Sitemap to passively map everything your browser hits, then promote interesting requests to Repeater/Intruder. See [Web Proxies](../2-pre-exploitation/02-web-proxies.rmd).

---

## See Also
- [DNS Reconnaissance](./02-dns-recon.rmd) — feeds subdomains into web recon.
- [Web Exploits](../3-exploitation/04-web-exploits.rmd) — what to do with the endpoints you've found.
- [Web Proxies](../2-pre-exploitation/02-web-proxies.rmd) — Burp / ZAP setup for active inspection.
